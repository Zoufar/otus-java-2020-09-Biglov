...
// done    //todo: 1. Добавить поля field11 - field13 (для field13 используйте класс ObjectForMessage)
    ...
    public Message copy(){
        Message copy = this;
        if(!(field13==null)){copy = new Message(id, field1, field2, field3, field4, field5, field6,
                field7, field8, field9, field10, field11, field12, field13.copy());}
        return copy;
    }
